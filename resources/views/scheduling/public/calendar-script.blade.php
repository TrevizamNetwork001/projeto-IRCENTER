 ...
 async function selectDate(button,date){
  ...
  try{
   ...
   data.slots.forEach(slot=>{
    ...
    const button=document.createElement('button');button.type='button';button.className='slot-button';button.innerHTML='<span class="slot-time">'+timeRange(slot)+'</span><span class="slot-check" aria-hidden="true">✓</span>';button.setAttribute('aria-label','Selecionar '+slot.label);button.setAttribute('aria-pressed','false');
